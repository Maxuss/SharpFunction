...
namespace SharpFunction.Addons.Skyblock
{
    ...
    public sealed class SkyblockSeaCreature
    {
        ...
        public SkyblockSeaCreature(string mob, string item, int lvl, int hp, RawText name, string rawName,
            ItemRarity rarity)
        {
            Mob = mob;
            MobItem = item;
        ...
        public string GenerateItem()
        {
            ...
            RawText de = new();
            de.AddField(MobRarity.GetStringValue(), MobRarity.GetRarityColor(), RawTextFormatting.Straight,
