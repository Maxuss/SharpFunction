...
namespace SharpFunction.Addons.Skyblock
{
    ...
    public sealed class SkyblockSlayer
    {
        ...
        public SkyblockSlayer(SkyblockItem[] items, SlayerTier[] tiers, SlayerDrop[] drops, SlayerLevel[] levels, FunctionWriter writer, string name)
        {
            SlayerItems = items;
            SlayerTiers = tiers;
            SlayerDrops = drops;
        ...
        public void Generate()
        {
            ...
            slm.Append($"# This script is used to generate leveling rewards for {SlayerBossName} Slayer", "# This file is PRE-GENERATED by SharpFunction", " ");
            foreach(SlayerLevel sl in Levels)
            {
                string cmd = sl.Compile();
                slm.Append($"#########", cmd, " ");
            }
