...
namespace SharpFunction.Exceptions
{
    ...
    public class InitializationException : SFException
    {
        ...
        public InitializationException(string fieldName) : base(
            $"You can not access field {fieldName} before initialization!")
        {
        }

        /// <inheritdoc cref="SFException(string, Exception)" />
        public InitializationException(string fieldName, Exception innerException) : base(
            $"You can not access field {fieldName} before initialization!", innerException)
        {
        }
    }
}