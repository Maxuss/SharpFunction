...
{
    /// <summary>
    ///     Represents advancement command. Equal to Minecraft's
    ///     <code>/advancement {grant/revoke} {[only {advancement}]/everything} {criterion}</code>
    /// </summary>
    public sealed class Advancement : ICommand, ISelectorCommand
    {
        ...
        public string GetAdvancement(VA adv)
        {
            ...
            var s = (Dictionary<VA, string>) Achievment;
