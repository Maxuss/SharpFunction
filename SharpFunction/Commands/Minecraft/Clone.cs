...
{
    /// <summary>
    ///     Represents clone command. Equal to Minecraft's
    ///     <code>/clone {pos1: Vector3} {pos2: Vector3} {destination: Vector3} {params}</code>
    /// </summary>
    public sealed class Clone : ICommand
    {
        ...
        {
            var p1 = corner1.String();
            var p2 = corner2.String();
            var dest = destination.String();
            var extr = string.Empty;
            var kwextra = string.Empty;
            switch (@params)
            {
