...
namespace SharpFunction.Writer
{
    ...
    public sealed class FunctionWriter : AbstractWriter
    {
        ...
        private string[] createdFunctions = { };
        ...
        public FunctionWriter(API.Project project)
        {
        ...
        public void CreateFunction(string name)
        {
            ...
            File.WriteAllText(global::System.IO.Path.Combine(tmp, $"{name}.mcfunction".ToLower().Replace(" ", "_")), "# Pre-Generated file using SharpFunction ");
        }
        ...
        /// <param name="name">Name of function. Not case sensitive</param>
        public void WriteCommand(Commands.CommandModule command, string name)
        {
            string tmp;
